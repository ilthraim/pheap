...
HD_PWD='C:/Users/mobil/ThesisIncludes/pheap/pheapVivado/pheapVivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pheap.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pheap.tcl
