...
HD_PWD='C:/Users/mobil/ThesisIncludes/pheap/pheapVivado/pheapVivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pheap.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pheap.tcl -notrace
